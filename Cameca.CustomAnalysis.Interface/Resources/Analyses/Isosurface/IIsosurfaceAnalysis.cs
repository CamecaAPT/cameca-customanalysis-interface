...
{
    Task<ReadOnlyMemory<IndexedTriangleArray>> BuildIsosurface(IBuildIsosurfaceParameters parameters, float isoLevel, IProgress<double>? progress = null, CancellationToken cancellationToken = default);
